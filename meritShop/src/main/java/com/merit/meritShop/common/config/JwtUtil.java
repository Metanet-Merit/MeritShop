...
import com.merit.meritShop.user.service.CustomUserDetailService;
...
public class JwtUtil implements Serializable {
    ...
    private String doGenerateToken(Map<String, Object> claims, UserToken userToken) {
        ...
        return Jwts.builder().setClaims(claims).setSubject(userToken.getEmail()).setIssuedAt(new Date(System.currentTimeMillis()))
